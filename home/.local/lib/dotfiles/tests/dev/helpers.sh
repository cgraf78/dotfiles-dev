...
# Load the standalone doctor extension API for focused in-process tests.
...
# dev-launchers-test owns the public wrapper. Resolve the host payload when a
